...
export const PiLoader = (props: Props) => {
  return (
      <>
          {
              props.loading &&
              <div className={'absolute inset-0 backdrop-blur-sm bg-white/30 dark:bg-gray-900/30 z-[9999999999999999999999999999999999999999999]'}>
